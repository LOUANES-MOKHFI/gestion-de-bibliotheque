      ...
      <div class="nav">
          <ul class="nav-list">
            <li class="list listpuit1">Gestion des Livres <i class="glyphicon glyphicon-chevron-down"></i>
                <ul class="ul1">
            <li class="list"><a href="livre.jsp">Liste des Livres</a></li>
            <li class="list"><a href="addlivre.jsp">Ajouter un Livre</a></li>
            <li class="list"><a href="updatelivre.jsp">Modifier un Livre</a></li>
                </ul>
            </li>
          </ul>
      </div>
  ...
  <strong>Success!</strong> <% out.print(c);} %>
      ...
      <div class="logo">
       ...
       <h3 class="panel-title">Liste des Livres</h3>
              ...
              <jsp:useBean id="obj" class="DOA.db_livre"/> 
        ...
        <table class="table table-hover table-bordered table-list ">
          <thead>
             <tr class='row-name'>
                  ...
                  <th  width = 15%>Nombre de page</th>
                  <th  width = 15%>Domaine</th>
                  <th  width = 40%>Action</th>
              </tr>
          </thead>
          <tbody id="myTable">
          <c:forEach var="auteur" items="${obj.getlivre()}"> 
                <tr>
                 <form method='POST' action='affichepuit.php'>    
                  <td><c:out value="${ auteur.getTitre()}" /> </td>
                  <td><c:out value="${ auteur.getNbr_page()}" /> </td>
                  <td><c:out value="${ auteur.getDomaine()}" /> </td>
                  <td><a href='affichepuit.php?id=$datas->id_puit' class='btn btn-primary' >Modifier</a>
                  <input type='submit' name='' value='Supprimer' class='btn btn-danger'></td>
                 </form>
                </tr>    
                 </c:forEach>
          </tbody>

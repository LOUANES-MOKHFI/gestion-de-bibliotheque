...
<section class="mbr-navbar mbr-navbar--freeze mbr-navbar--sticky mbr-navbar--auto-collapse" id="menu-93">
    ...
    <div class=" col-lg-3 col-md-3 col-xs-12">
      <div class="nav">
          <ul class="nav-list">
            <li class="list listpuit1"><a href="search.jsp">Rechercher un auteur</a></li>
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="#">Rechercher</a></li>
       <li class="active">Recherche un auteur</li>
    </ol>
  </div> 
...
<span class="alert alert-danger alert-dismissible">
  ...
  <strong>erreur!</strong> <% out.print(c);} %>
           ...
           <div class="form-group">
               <form method="get" action="../controller/searchauteur">
                <input type="text" class="form-control" name="nom_aut" id="name" placeholder="Nom de l'auteur" required="required">
        ...
        <table class="table table-hover table-bordered table-list ">
              <div class="panel-table">
 	      		...
 	      		<tr>
 	      			...
 	      			<td>  <% Object nom = session.getAttribute("nom");
                                 if(nom!=null){ out.print(nom);}%></td>
 	      		</tr>
 	      		<tr>
 	      			<td> <label>Prenom :</label></td>
 	      			<td>  <% Object prenom = session.getAttribute("prenom");
                                 if(prenom!=null){ out.print(prenom);}%></td>
 	      		</tr>
                        <tr>
                                <td><label>Email :</label></td>
                               <td>  <% Object email = session.getAttribute("email");
                                 if(email!=null){ out.print(email);}%></td>
                        </tr>
                        <tr>
                                <td><label>Date de Naissance :</label></td>
                                <td>  <% Object date_nais = session.getAttribute("date_nais");
